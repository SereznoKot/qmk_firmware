 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |CapsLock|      |   1  |   2  |   3  |   4  |      |           |      |   7  |   8  |   9  |   0  |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |   Q  |   W  |   E  |   R  |   T  |  5   |           |   6  |   Y  |   U  |   I  |   O  |   P  |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LShift |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  | RShift |
 * |--------+------+------+------+------+------|      |           | LGui |------+------+------+------+------+--------|
 * |CtrlShft|Z/LCtl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//LCtl| ~MDIA  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | Left | Right|                                       | Down |  Up  |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        // left hand
        KC_CAPSLOCK,     KC_NO,       KC_1,  KC_2,    KC_3,    KC_4,   KC_NO,
        KC_NO,           KC_Q,        KC_W,  KC_E,    KC_R,    KC_T,   KC_5,
        KC_LSHIFT,       KC_A,        KC_S,  KC_D,    KC_F,    KC_G,
        LCTL(KC_LSHIFT), CTL_T(KC_Z), KC_X,  KC_C,    KC_V,    KC_B,   KC_NO,
        ...
        // right hand
             ...
             KC_LGUI, KC_N,   KC_M,    KC_COMM, KC_DOT, CTL_T(KC_SLSH), MO(MDIA),
...
[SYMB] = KEYMAP(
       ...
       KC_NO,   KC_NO,     KC_BSLASH, KC_LCBR, KC_RCBR, KC_PLUS,  KC_F5,
       KC_TRNS, KC_CIRC,   KC_PIPE,   KC_LPRN, KC_RPRN, KC_ASTR,
       ...
       // right hand
       KC_NO, KC_F7,     KC_F8,   KC_F9,   KC_F10,   KC_NO,   KC_NO,
       KC_F6, KC_MINS,   KC_EQL,  KC_TILD, KC_DQT,   KC_NO,   KC_F11,
              KC_DLR,    KC_EXLM, KC_HASH, KC_QUOTE, KC_PERC, KC_F12,
       KC_NO, KC_NO,     KC_AMPR, KC_AT,   KC_GRAVE, KC_NO,   KC_DELETE,
